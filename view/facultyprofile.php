                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group"><label class="small mb-1">Name</label><input class="form-control py-4"  type="text" aria-describedby="nameHelp" value="<?php echo $row['facultyname'];?>" name="facultyname" readonly/></div>
                                            <div class="form-group"><label class="small mb-1">Department</label><input class="form-control py-4" type="text" aria-describedby="nameHelp" value="<?php echo $row['department'];?>" name="department" readonly/></div>
                                            ...
                                            <div class="form-group mt-4 mb-0"><a href="facultyedit.php" class="btn btn-primary btn-block">Edit Profile</a></div>
