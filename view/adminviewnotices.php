                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="admincssem.php">Computer Science</a><a class="nav-link" href="admincomsem.php">Commerce</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>ALL NOTICES</div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <form method="POST">
                                                ...
                                                <td><a href="admineditnotices.php?id=<?php echo $row['noticeid']; ?>" class="btn-primary form-control">Edit</a></td>
                                                <td><input type="submit" value="Remove" class="btn-danger form-control" name="submit"></td>
