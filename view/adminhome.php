                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapse" aria-labelledby="headingThree" data-parent="#sidenavAccordion">
                                ...
                                <a class="nav-link" href="adminviewnotices">View Notice</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Faculty Application</h1>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            <form method="POST">
                                                <td><input type="text" readonly value="<?php echo $row['fid'];?>" name="fid"></td>
                                                ...
                                                <td><input type="submit" value="Approve" class="btn-success form-control" name="submit"></td>
